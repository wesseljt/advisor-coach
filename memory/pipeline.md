...
- **Cyberknit** — Scoping, **$45k fixed-fee project total** (logged in Notion 8/31, Contract Terms = Fixed Fee). One-time — does NOT move MRR. OPEN: quote/SOW send date; advisor push: structure a post-project retainer tail into the proposal.
