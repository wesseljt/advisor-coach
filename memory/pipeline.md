...
- **Cyberknit** — Scoping, **$45k fixed-fee project total** (logged in Notion 8/31, Contract Terms = Fixed Fee). One-time — does NOT move MRR by itself, but John confirms a retainer/maintenance tail is a real possibility. AGREED: price the monthly retainer option INTO the same SOW (don't wait until after delivery). OPEN: quote/SOW send date.
