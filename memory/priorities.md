...
3. **Package the Spark Hire demo** as a forwardable Loom + one-pager. Pipeline is ~half the size the goal requires (need 4–5 live deals, have 2), so this asset is the multiplier.
